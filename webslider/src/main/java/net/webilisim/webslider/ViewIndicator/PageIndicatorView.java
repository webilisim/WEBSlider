...
import net.webilisim.webslider.ViewIndicator.draw.data.PositionSavedState;
import net.webilisim.webslider.ViewIndicator.draw.data.RtlMode;
import net.webilisim.webslider.ViewIndicator.utils.CoordinatesUtils;
import net.webilisim.webslider.ViewIndicator.utils.DensityUtils;
import net.webilisim.webslider.ViewIndicator.utils.IdUtils;
